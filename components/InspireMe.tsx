...
//     // formulate a question and ask OpenAI
//     const inspireMeArray: any[] = [];
//     const [inspireMeMessages] =  useCollection(
//       session &&
//       query(
//           collection(db, "users", session?.user?.email!, "chats", chatId, "messages"),
...
//     ));
//     inspireMeMessages?.docs.forEach((message) => (
//       inspireMeArray.push([message.data().text,  message.data().user.user_action])
//   ));

//     console.log("inspireMeMessage: ", inspireMeArray)
